...
<div id="header">
  <div class="header_inner">
    ...
    <div class="search">
      <form action="http://localhost:10006/search.html" id="searchForm" name="query" method="GET">
    ...
    <div class="shopingcar" id="topCart">
      <s class="setCart"></s><a href="http://localhost:10011/cart/cart.html" class="t" rel="nofollow">我的购物车</a><b id="cartNum">0</b>
