...
<table class="easyui-datagrid" id="itemList" title="" style="height:600px"
    ...
    <tr>
        ...
        <th data-options="field:'id',width:120">商品号</th>
        <th data-options="field:'title',width:200">商品标题</th>
        <th data-options="field:'cid',width:80">分类ID</th>
        <th data-options="field:'sellPoint',width:200">卖点</th>
        <th data-options="field:'price',width:100,align:'right',formatter:E3.formatPrice">价格</th>
        <th data-options="field:'num',width:80,align:'right'">库存数量</th>
...
<div id="itemEditWindow" class="easyui-window" title="编辑商品"
     data-options="modal:true,closed:true,href:'/item-edit'"
